...
export default class MainMenu extends Scene {
    ...
    startScene(){
        ...
        // HOMEWORK 4 - TODO: Give yourself credit and add your name to the about page! (DONE)
        const text1 = "This game was created by Kevin Duong, Zachary Grandison, and Richard McKenna";
